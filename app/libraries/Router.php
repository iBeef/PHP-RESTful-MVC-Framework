...
class Router {
    ...
    */
    ...
    /**
     * Stores the POST route and user defined fucntion to the $postRoutes assoc array.
     *
     * @access public
     * @param string $route
     * @param  function $fn
    ...
    /**
     * Stores the PUT route and user defined fucntion to the $putRoutes assoc array.
     *
     * @access public
     * @param string $route
     * @param  function $fn
    ...
    /**
     * Stores the DELETE route and user defined fucntion to the $deleteRoutes assoc array.
     *
     * @access public
     * @param string $route
     * @param  function $fn
    ...
    /**
     * Called at thhe bottom of index.php to run the class and route the url request.
     *
     * @access public
     * @return void
     */
